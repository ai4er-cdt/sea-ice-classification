...
if __name__ == "__main__":
    ...
    test_jaccard = jaccard_score(Y_test_data, y_pred, average='macro')
    test_accuracy = accuracy_score(Y_test_data, y_pred)
    test_micro_precision = precision_score(Y_test_data, y_pred, average="micro")
    test_macro_precision = precision_score(Y_test_data, y_pred, average="macro")
    test_weighted_precision = precision_score(Y_test_data, y_pred, average="weighted")
    test_micro_recall = recall_score(Y_test_data, y_pred, average="micro")
    test_macro_recall = recall_score(Y_test_data, y_pred, average="macro")
    test_weighted_recall = recall_score(Y_test_data, y_pred, average="weighted")
    test_micro_f1 = f1_score(Y_test_data, y_pred, average="micro")
    test_macro_f1 = f1_score(Y_test_data, y_pred, average="macro")
    test_weighted_f1 = f1_score(Y_test_data, y_pred, average="weighted")
    ...
    test_l_loss = log_loss(Y_test_data, y_pred)    
    test_roc_auc = roc_auc_score(Y_test_data, y_prob[:, 1])
